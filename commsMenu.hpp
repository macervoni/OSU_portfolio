...
Header file for derived class CommsMenu.
...
#ifndef COMMS_MENU_HPP
#define COMMS_MENU_HPP
...
class CommsMenu : public RoomMenu
{
...
public:
    ...
    CommsMenu(Spaceship * theConnectedSpaceship, Inventory * theConnectedInventory);
